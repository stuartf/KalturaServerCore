...
abstract class BaseEntryDistributionPeer {
	...
	public static function updateInstancePool(&$queryResult)
	{
		...
		{
			$objFromPool = EntryDistributionPeer::getInstanceFromPool($curObject->getPrimaryKey());
			if ($objFromPool === null)
			{
				EntryDistributionPeer::addInstanceToPool($curObject);
			}
			else
			{
	...
	public static function addInstancesToPool($queryResult)
	{
		...
		{
			EntryDistributionPeer::addInstanceToPool($curResult);
		}
	}
