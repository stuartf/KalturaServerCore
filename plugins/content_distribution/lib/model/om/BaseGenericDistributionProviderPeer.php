...
abstract class BaseGenericDistributionProviderPeer {
	...
	public static function updateInstancePool(&$queryResult)
	{
		...
		{
			$objFromPool = GenericDistributionProviderPeer::getInstanceFromPool($curObject->getPrimaryKey());
			if ($objFromPool === null)
			{
				GenericDistributionProviderPeer::addInstanceToPool($curObject);
			}
			else
			{
	...
	public static function addInstancesToPool($queryResult)
	{
		...
		{
			GenericDistributionProviderPeer::addInstanceToPool($curResult);
		}
	}
