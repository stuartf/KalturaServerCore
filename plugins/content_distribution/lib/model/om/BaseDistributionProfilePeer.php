...
abstract class BaseDistributionProfilePeer {
	...
	public static function updateInstancePool(&$queryResult)
	{
		...
		{
			$objFromPool = DistributionProfilePeer::getInstanceFromPool($curObject->getPrimaryKey());
			if ($objFromPool === null)
			{
				DistributionProfilePeer::addInstanceToPool($curObject);
			}
			else
			{
	...
	public static function addInstancesToPool($queryResult)
	{
		...
		{
			DistributionProfilePeer::addInstanceToPool($curResult);
		}
	}
