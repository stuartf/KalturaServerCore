...
abstract class BaseAuditTrailPeer {
	...
	const CLASS_DEFAULT = 'plugins.audit.AuditTrail';
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$con = AuditTrailPeer::alternativeCon ($con, $queryDB);
	...
	public static function updateInstancePool(&$queryResult)
	{
		...
		{
			$objFromPool = AuditTrailPeer::getInstanceFromPool($curObject->getPrimaryKey());
			if ($objFromPool === null)
			{
				AuditTrailPeer::addInstanceToPool($curObject);
			}
			else
			{
	...
	public static function addInstancesToPool($queryResult)
	{
		...
		{
			AuditTrailPeer::addInstanceToPool($curResult);
		}
	}
	...
	{		
		$criteria = AuditTrailPeer::prepareCriteriaForSelect($criteria);
		...
		if ($cachedResult !== null)
		{
			AuditTrailPeer::filterSelectResults($cachedResult);
		...
		AuditTrailPeer::filterSelectResults($queryResult);
		AuditTrailPeer::addInstancesToPool($queryResult);
		return $queryResult;
	}
