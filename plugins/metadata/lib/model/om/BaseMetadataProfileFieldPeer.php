...
abstract class BaseMetadataProfileFieldPeer {
	...
	public static function updateInstancePool(&$queryResult)
	{
		...
		{
			$objFromPool = MetadataProfileFieldPeer::getInstanceFromPool($curObject->getPrimaryKey());
			if ($objFromPool === null)
			{
				MetadataProfileFieldPeer::addInstanceToPool($curObject);
			}
			else
			{
	...
	public static function addInstancesToPool($queryResult)
	{
		...
		{
			MetadataProfileFieldPeer::addInstanceToPool($curResult);
		}
	}
