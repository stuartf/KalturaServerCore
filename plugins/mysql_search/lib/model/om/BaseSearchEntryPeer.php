...
abstract class BaseSearchEntryPeer {
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$con = SearchEntryPeer::alternativeCon ($con, $queryDB);
	...
	public static function updateInstancePool(&$queryResult)
	{
		...
		{
			$objFromPool = SearchEntryPeer::getInstanceFromPool($curObject->getPrimaryKey());
			if ($objFromPool === null)
			{
				SearchEntryPeer::addInstanceToPool($curObject);
			}
			else
			{
	...
	public static function addInstancesToPool($queryResult)
	{
		...
		{
			SearchEntryPeer::addInstanceToPool($curResult);
		}
	}
	...
	{		
		$criteria = SearchEntryPeer::prepareCriteriaForSelect($criteria);
		...
		if ($cachedResult !== null)
		{
			SearchEntryPeer::filterSelectResults($cachedResult);
			SearchEntryPeer::updateInstancePool($cachedResult);
			return $cachedResult;
		}
		...
		SearchEntryPeer::filterSelectResults($queryResult);
		SearchEntryPeer::addInstancesToPool($queryResult);
		return $queryResult;
	}
