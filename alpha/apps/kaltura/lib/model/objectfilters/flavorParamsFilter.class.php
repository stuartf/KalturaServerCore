...
class flavorParamsFilter extends baseObjectFilter
{
	...
	public function describe() 
	{
		return 
			array (
				"display_name" => "FlavorParamsFilter",
				"desc" => ""
			);
	}
	...
	{
		$res = flavorParamsPeer::translateFieldName( $field_name , $this->field_name_translation_type , BasePeer::TYPE_COLNAME );
		return $res;
	}

	public function getIdFromPeer (  )
	{
		return flavorParamsPeer::ID;
	}
}
