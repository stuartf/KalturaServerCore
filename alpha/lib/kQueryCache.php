...
class kQueryCache 
{
	...
	protected static function initGlobalMemcache()
	{
		...
		self::$s_memcacheKeys = kCacheManager::getMemcache(kCacheManager::MC_GLOBAL_KEYS);
		...
		self::$s_memcacheQueries = kCacheManager::getMemcache(kCacheManager::MC_GLOBAL_QUERIES);
	}
