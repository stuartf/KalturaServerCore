...
/**
 * Base static class for performing query and update operations on the 'partner_activity' table.
 *
 * 
 *
 * @package Core
...
abstract class BasePartnerActivityPeer {
	...
	/** the column name for the ACTIVITY_DATE field */
	...
	/** the column name for the SUB_ACTIVITY field */
	...
	/** the column name for the AMOUNT4 field */
	const AMOUNT4 = 'partner_activity.AMOUNT4';

	/** the column name for the AMOUNT5 field */
	const AMOUNT5 = 'partner_activity.AMOUNT5';

	/** the column name for the AMOUNT6 field */
	const AMOUNT6 = 'partner_activity.AMOUNT6';

	/** the column name for the AMOUNT7 field */
	const AMOUNT7 = 'partner_activity.AMOUNT7';

	/** the column name for the AMOUNT9 field */
	const AMOUNT9 = 'partner_activity.AMOUNT9';

	/**
	 * An identiy map to hold any loaded instances of PartnerActivity objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array PartnerActivity[]
	 */
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'partnerId', 'activityDate', 'activity', 'subActivity', 'amount', 'amount1', 'amount2', 'amount3', 'amount4', 'amount5', 'amount6', 'amount7', 'amount9', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::PARTNER_ID, self::ACTIVITY_DATE, self::ACTIVITY, self::SUB_ACTIVITY, self::AMOUNT, self::AMOUNT1, self::AMOUNT2, self::AMOUNT3, self::AMOUNT4, self::AMOUNT5, self::AMOUNT6, self::AMOUNT7, self::AMOUNT9, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'partnerId' => 1, 'activityDate' => 2, 'activity' => 3, 'subActivity' => 4, 'amount' => 5, 'amount1' => 6, 'amount2' => 7, 'amount3' => 8, 'amount4' => 9, 'amount5' => 10, 'amount6' => 11, 'amount7' => 12, 'amount9' => 13, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::PARTNER_ID => 1, self::ACTIVITY_DATE => 2, self::ACTIVITY => 3, self::SUB_ACTIVITY => 4, self::AMOUNT => 5, self::AMOUNT1 => 6, self::AMOUNT2 => 7, self::AMOUNT3 => 8, self::AMOUNT4 => 9, self::AMOUNT5 => 10, self::AMOUNT6 => 11, self::AMOUNT7 => 12, self::AMOUNT9 => 13, ),
	 ...
	 * @param      string $column The column name for current table. (i.e. PartnerActivityPeer::COLUMN_NAME).
	 * @return     string
	 */
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$criteria->setPrimaryTableName(PartnerActivityPeer::TABLE_NAME);
	...
	{
		$criteria_filter = PartnerActivityPeer::getCriteriaFilter();
	...
	{
		PartnerActivityPeer::getCriteriaFilter()->applyFilter($criteria);
	}
	 ...
	 *
	 * @param      mixed $value A PartnerActivity object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof PartnerActivity) {
				$key = (string) $value->getId();
			} elseif (is_scalar($value)) {
				// assume we've been passed a primary key
				$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or PartnerActivity object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     PartnerActivity Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to partner_activity
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = PartnerActivityPeer::getOMClass(false);
		// populate the object(s)
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key = PartnerActivityPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj = PartnerActivityPeer::getInstanceFromPool($key))) {
	...
	{
	  $dbMap = Propel::getDatabaseMap(BasePartnerActivityPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BasePartnerActivityPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new PartnerActivityTableMap());
	  }
	}
	...
	{
		return $withPrefix ? PartnerActivityPeer::CLASS_DEFAULT : PartnerActivityPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a PartnerActivity or Criteria object.
	 *
	 * @param      mixed $values Criteria or PartnerActivity object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from PartnerActivity object
		}

		if ($criteria->containsKey(PartnerActivityPeer::ID) && $criteria->keyContainsValue(PartnerActivityPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.PartnerActivityPeer::ID.')');
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a PartnerActivity or Criteria object.
	 *
	 * @param      mixed $values Criteria or PartnerActivity object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		} else { // $values is PartnerActivity object
	...
	/**
	 * Method to DELETE all rows from the partner_activity table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			PartnerActivityPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Method perform a DELETE on the database, given a PartnerActivity or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or PartnerActivity object or primary key or array of primary keys
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
		...
		} elseif ($values instanceof PartnerActivity) { // it's a model object
			// invalidate the cache for this single object
			PartnerActivityPeer::removeInstanceFromPool($values);
			...
			foreach ((array) $values as $singleval) {
				PartnerActivityPeer::removeInstanceFromPool($singleval);
			}
		}
	...
	/**
	 * Validates all modified columns of given PartnerActivity object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      PartnerActivity $obj The object to validate.
	...
	public static function doValidate(PartnerActivity $obj, $cols = null)
	{
		...
		return BasePeer::doValidate(PartnerActivityPeer::DATABASE_NAME, PartnerActivityPeer::TABLE_NAME, $columns);
	}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = PartnerActivityPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
...
} // BasePartnerActivityPeer

// This is the static code needed to register the TableMap for this table with the main Propel class.
//
BasePartnerActivityPeer::buildTableMap();
