...
/**
 * Base static class for performing query and update operations on the 'flag' table.
 *
 * 
 *
 * @package Core
...
abstract class BaseflagPeer {
	...
	const CLASS_DEFAULT = 'Core.flag';

	/** the related TableMap class for this table */
	const TM_CLASS = 'flagTableMap';
	...
	/**
	 * An identiy map to hold any loaded instances of flag objects.
	 ...
	 * @param      string $column The column name for current table. (i.e. flagPeer::COLUMN_NAME).
	 * @return     string
	 */
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$criteria->setPrimaryTableName(flagPeer::TABLE_NAME);
	...
	public static function updateInstancePool(&$queryResult)
	{
		...
		{
			$objFromPool = flagPeer::getInstanceFromPool($curObject->getPrimaryKey());
			if ($objFromPool === null)
			{
				flagPeer::addInstanceToPool($curObject);
			}
			else
			{
	...
	public static function addInstancesToPool($queryResult)
	{
		...
		{
			flagPeer::addInstanceToPool($curResult);
		}
	}
	...
	{
		$criteria_filter = flagPeer::getCriteriaFilter();
	...
	public static function doCountStmt(Criteria $criteria, PropelPDO $con = null)
	{
		...
		$con = flagPeer::alternativeCon ( $con );
	 ...
	 *
	 * @param      mixed $value A flag object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof flag) {
				$key = (string) $value->getId();
			} elseif (is_scalar($value)) {
				// assume we've been passed a primary key
				$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or flag object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     flag Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to flag
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = flagPeer::getOMClass(false);
		// populate the object(s)
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key = flagPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj = flagPeer::getInstanceFromPool($key))) {
	...
	public static function doSelectJoinkuser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key1 = flagPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj1 = flagPeer::getInstanceFromPool($key1))) {
				// We no longer rehydrate the object, since this can cause data loss.
				// See http://propel.phpdb.org/trac/ticket/509
	...
	/**
	 * Selects a collection of flag objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseflagPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseflagPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new flagTableMap());
	  }
	}
	...
	{
		return $withPrefix ? flagPeer::CLASS_DEFAULT : flagPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a flag or Criteria object.
	 *
	 * @param      mixed $values Criteria or flag object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(flagPeer::ID) && $criteria->keyContainsValue(flagPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.flagPeer::ID.')');
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a flag or Criteria object.
	 *
	 * @param      mixed $values Criteria or flag object containing data that is used to create the UPDATE statement.
	...
	/**
	 * Method to DELETE all rows from the flag table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			flagPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Method perform a DELETE on the database, given a flag or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or flag object or primary key or array of primary keys
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
		...
		} elseif ($values instanceof flag) { // it's a model object
			// invalidate the cache for this single object
			flagPeer::removeInstanceFromPool($values);
			...
			foreach ((array) $values as $singleval) {
				flagPeer::removeInstanceFromPool($singleval);
			}
		}
	...
	/**
	 * Validates all modified columns of given flag object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      flag $obj The object to validate.
	...
	public static function doValidate(flag $obj, $cols = null)
	{
		...
		return BasePeer::doValidate(flagPeer::DATABASE_NAME, flagPeer::TABLE_NAME, $columns);
	}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = flagPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
