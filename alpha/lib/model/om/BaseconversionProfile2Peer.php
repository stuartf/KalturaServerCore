...
abstract class BaseconversionProfile2Peer {
	...
	public static function updateInstancePool(&$queryResult)
	{
		...
		{
			$objFromPool = conversionProfile2Peer::getInstanceFromPool($curObject->getPrimaryKey());
			if ($objFromPool === null)
			{
				conversionProfile2Peer::addInstanceToPool($curObject);
			}
			else
			{
	...
	public static function addInstancesToPool($queryResult)
	{
		...
		{
			conversionProfile2Peer::addInstanceToPool($curResult);
		}
	}
