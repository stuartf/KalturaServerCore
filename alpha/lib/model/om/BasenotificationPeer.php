...
abstract class BasenotificationPeer {
	...
	const CLASS_DEFAULT = 'Core.notification';
	...
	public static function updateInstancePool(&$queryResult)
	{
		...
		{
			$objFromPool = notificationPeer::getInstanceFromPool($curObject->getPrimaryKey());
			if ($objFromPool === null)
			{
				notificationPeer::addInstanceToPool($curObject);
			}
			else
			{
	...
	public static function addInstancesToPool($queryResult)
	{
		...
		{
			notificationPeer::addInstanceToPool($curResult);
		}
	}
