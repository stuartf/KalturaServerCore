...
/**
 * Base static class for performing query and update operations on the 'scheduler_status' table.
 *
 * 
 *
 * @package Core
...
abstract class BaseSchedulerStatusPeer {
	...
	const OM_CLASS = 'SchedulerStatus';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'Core.SchedulerStatus';

	/** the related TableMap class for this table */
	const TM_CLASS = 'SchedulerStatusTableMap';
	...
	/** the column name for the WORKER_TYPE field */
	...
	/**
	 * An identiy map to hold any loaded instances of SchedulerStatus objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array SchedulerStatus[]
	 */
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'createdAt', 'createdBy', 'updatedAt', 'updatedBy', 'schedulerId', 'schedulerConfiguredId', 'workerId', 'workerConfiguredId', 'workerType', 'type', 'value', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::CREATED_AT, self::CREATED_BY, self::UPDATED_AT, self::UPDATED_BY, self::SCHEDULER_ID, self::SCHEDULER_CONFIGURED_ID, self::WORKER_ID, self::WORKER_CONFIGURED_ID, self::WORKER_TYPE, self::TYPE, self::VALUE, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'createdAt' => 1, 'createdBy' => 2, 'updatedAt' => 3, 'updatedBy' => 4, 'schedulerId' => 5, 'schedulerConfiguredId' => 6, 'workerId' => 7, 'workerConfiguredId' => 8, 'workerType' => 9, 'type' => 10, 'value' => 11, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::CREATED_AT => 1, self::CREATED_BY => 2, self::UPDATED_AT => 3, self::UPDATED_BY => 4, self::SCHEDULER_ID => 5, self::SCHEDULER_CONFIGURED_ID => 6, self::WORKER_ID => 7, self::WORKER_CONFIGURED_ID => 8, self::WORKER_TYPE => 9, self::TYPE => 10, self::VALUE => 11, ),
	 ...
	 * @param      string $column The column name for current table. (i.e. SchedulerStatusPeer::COLUMN_NAME).
	 * @return     string
	 */
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$criteria->setPrimaryTableName(SchedulerStatusPeer::TABLE_NAME);
	...
	public static function updateInstancePool(&$queryResult)
	{
		...
		{
			$objFromPool = SchedulerStatusPeer::getInstanceFromPool($curObject->getPrimaryKey());
			if ($objFromPool === null)
			{
				SchedulerStatusPeer::addInstanceToPool($curObject);
			}
			else
			{
	...
	public static function addInstancesToPool($queryResult)
	{
		...
		{
			SchedulerStatusPeer::addInstanceToPool($curResult);
		}
	}
	...
	public static function alternativeCon($con, $queryDB = kQueryCache::QUERY_DB_UNDEFINED)
	{
		...
		if($con === null)
			$con = Propel::getConnection(SchedulerStatusPeer::DATABASE_NAME, Propel::CONNECTION_READ);
	...
	{
		$criteria_filter = SchedulerStatusPeer::getCriteriaFilter();
	...
	public static function doCountStmt(Criteria $criteria, PropelPDO $con = null)
	{
		...
		$con = SchedulerStatusPeer::alternativeCon ( $con );
	 ...
	 *
	 * @param      SchedulerStatus $value A SchedulerStatus object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(SchedulerStatus $obj, $key = null)
	{
	 ...
	 *
	 * @param      mixed $value A SchedulerStatus object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof SchedulerStatus) {
				$key = (string) $value->getId();
			} elseif (is_scalar($value)) {
				// assume we've been passed a primary key
				$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or SchedulerStatus object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     SchedulerStatus Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to scheduler_status
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = SchedulerStatusPeer::getOMClass(false);
		// populate the object(s)
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key = SchedulerStatusPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj = SchedulerStatusPeer::getInstanceFromPool($key))) {
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseSchedulerStatusPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseSchedulerStatusPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new SchedulerStatusTableMap());
	  }
	}
	...
	{
		return $withPrefix ? SchedulerStatusPeer::CLASS_DEFAULT : SchedulerStatusPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a SchedulerStatus or Criteria object.
	 *
	 * @param      mixed $values Criteria or SchedulerStatus object containing data that is used to create the INSERT statement.
	...
	{
		if ($con === null) {
			$con = Propel::getConnection(SchedulerStatusPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
		}

		if ($values instanceof Criteria) {
			$criteria = clone $values; // rename for clarity
		} else {
			$criteria = $values->buildCriteria(); // build Criteria from SchedulerStatus object
		}

		if ($criteria->containsKey(SchedulerStatusPeer::ID) && $criteria->keyContainsValue(SchedulerStatusPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.SchedulerStatusPeer::ID.')');
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a SchedulerStatus or Criteria object.
	 *
	 * @param      mixed $values Criteria or SchedulerStatus object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		} else { // $values is SchedulerStatus object
	...
	/**
	 * Method to DELETE all rows from the scheduler_status table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			SchedulerStatusPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Method perform a DELETE on the database, given a SchedulerStatus or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or SchedulerStatus object or primary key or array of primary keys
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
		...
		} elseif ($values instanceof SchedulerStatus) { // it's a model object
			// invalidate the cache for this single object
			SchedulerStatusPeer::removeInstanceFromPool($values);
			...
			foreach ((array) $values as $singleval) {
				SchedulerStatusPeer::removeInstanceFromPool($singleval);
			}
		}
	...
	/**
	 * Validates all modified columns of given SchedulerStatus object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      SchedulerStatus $obj The object to validate.
	...
	public static function doValidate(SchedulerStatus $obj, $cols = null)
	{
		...
		return BasePeer::doValidate(SchedulerStatusPeer::DATABASE_NAME, SchedulerStatusPeer::TABLE_NAME, $columns);
	}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = SchedulerStatusPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
...
} // BaseSchedulerStatusPeer

// This is the static code needed to register the TableMap for this table with the main Propel class.
//
BaseSchedulerStatusPeer::buildTableMap();
