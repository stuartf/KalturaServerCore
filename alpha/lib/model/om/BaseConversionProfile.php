...
/**
 * Base class that represents a row from the 'conversion_profile' table.
 *
 * 
 *
 * @package Core
...
abstract class BaseConversionProfile extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the commercial_transcoder field.
	 * @var        int
	 */
	...
	/**
	 * The value for the bypass_flv field.
	 * @var        int
	 */
	protected $bypass_flv;

	/**
	 * The value for the use_with_bulk field.
	 * @var        int
	 */
	...
	/**
	 * The value for the profile_type_suffix field.
	 * @var        string
	 */
	protected $profile_type_suffix;

	/**
	 * The value for the conversion_profile_2_id field.
	 * @var        int
	 */
	...
	/**
	 * Initializes internal state of BaseConversionProfile object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [commercial_transcoder] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Get the [bypass_flv] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Get the [use_with_bulk] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Get the [profile_type_suffix] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Get the [conversion_profile_2_id] column value.
	 * 
	 * @return     int
	 */
	 ...
	 * @return     ConversionProfile The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [commercial_transcoder] column.
	 * 
	 * @param      int $v new value
	 * @return     ConversionProfile The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [bypass_flv] column.
	 * 
	 * @param      int $v new value
	 * @return     ConversionProfile The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [use_with_bulk] column.
	 * 
	 * @param      int $v new value
	 * @return     ConversionProfile The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [profile_type_suffix] column.
	 * 
	 * @param      string $v new value
	 * @return     ConversionProfile The current object (for fluent API support)
	 */
	public function setProfileTypeSuffix($v)
	{
		...
		return $this;
	} // setProfileTypeSuffix()

	/**
	 * Set the value of [conversion_profile_2_id] column.
	 * 
	 * @param      int $v new value
	 * @return     ConversionProfile The current object (for fluent API support)
	 */
	public function setConversionProfile2Id($v)
	{
		...
		if ($this->conversion_profile_2_id !== $v) {
			...
			$this->modifiedColumns[] = ConversionProfilePeer::CONVERSION_PROFILE_2_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->commercial_transcoder = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			...
			$this->bypass_flv = ($row[$startcol + 9] !== null) ? (int) $row[$startcol + 9] : null;
			$this->use_with_bulk = ($row[$startcol + 10] !== null) ? (int) $row[$startcol + 10] : null;
			$this->created_at = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
			$this->updated_at = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
			$this->profile_type_suffix = ($row[$startcol + 13] !== null) ? (string) $row[$startcol + 13] : null;
			$this->conversion_profile_2_id = ($row[$startcol + 14] !== null) ? (int) $row[$startcol + 14] : null;
			$this->resetModified();
			...
			return $startcol + 15; // 15 = ConversionProfilePeer::NUM_COLUMNS - ConversionProfilePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		ConversionProfilePeer::setUseCriteriaFilter(false);
		$stmt = ConversionProfilePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
		ConversionProfilePeer::setUseCriteriaFilter(true);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				ConversionProfilePeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[14] => $this->getConversionProfile2Id(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[14], $arr)) $this->setConversionProfile2Id($arr[$keys[14]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ConversionProfilePeer::CONVERSION_PROFILE_2_ID)) $criteria->add(ConversionProfilePeer::CONVERSION_PROFILE_2_ID, $this->conversion_profile_2_id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ConversionProfile (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ConversionProfile Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @var     ConversionProfile Clone of current object.
	 */
	 ...
	 * Stores the source object that this object copied from 
	 *
	 * @param      ConversionProfile $copiedFrom Clone of current object.
	 */
	public function setCopiedFrom(ConversionProfile $copiedFrom)
	{
