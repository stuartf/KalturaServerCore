...
/**
 * Base static class for performing query and update operations on the 'email_ingestion_profile' table.
 *
 * 
 *
 * @package Core
...
abstract class BaseEmailIngestionProfilePeer {
	...
	const OM_CLASS = 'EmailIngestionProfile';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'Core.EmailIngestionProfile';

	/** the related TableMap class for this table */
	const TM_CLASS = 'EmailIngestionProfileTableMap';
	...
	/**
	 * An identiy map to hold any loaded instances of EmailIngestionProfile objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array EmailIngestionProfile[]
	 */
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'description', 'emailAddress', 'mailboxId', 'partnerId', 'conversionProfile2Id', 'moderationStatus', 'customData', 'status', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::DESCRIPTION, self::EMAIL_ADDRESS, self::MAILBOX_ID, self::PARTNER_ID, self::CONVERSION_PROFILE_2_ID, self::MODERATION_STATUS, self::CUSTOM_DATA, self::STATUS, self::CREATED_AT, self::UPDATED_AT, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'description' => 2, 'emailAddress' => 3, 'mailboxId' => 4, 'partnerId' => 5, 'conversionProfile2Id' => 6, 'moderationStatus' => 7, 'customData' => 8, 'status' => 9, 'createdAt' => 10, 'updatedAt' => 11, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::DESCRIPTION => 2, self::EMAIL_ADDRESS => 3, self::MAILBOX_ID => 4, self::PARTNER_ID => 5, self::CONVERSION_PROFILE_2_ID => 6, self::MODERATION_STATUS => 7, self::CUSTOM_DATA => 8, self::STATUS => 9, self::CREATED_AT => 10, self::UPDATED_AT => 11, ),
	 ...
	 * @param      string $column The column name for current table. (i.e. EmailIngestionProfilePeer::COLUMN_NAME).
	 * @return     string
	 */
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$criteria->setPrimaryTableName(EmailIngestionProfilePeer::TABLE_NAME);
		...
		EmailIngestionProfilePeer::attachCriteriaFilter($criteria);
	...
	public static function updateInstancePool(&$queryResult)
	{
		...
		{
			$objFromPool = EmailIngestionProfilePeer::getInstanceFromPool($curObject->getPrimaryKey());
			if ($objFromPool === null)
			{
				EmailIngestionProfilePeer::addInstanceToPool($curObject);
			}
			else
			{
	...
	public static function addInstancesToPool($queryResult)
	{
		...
		{
			EmailIngestionProfilePeer::addInstanceToPool($curResult);
		}
	}
	...
	public static function alternativeCon($con, $queryDB = kQueryCache::QUERY_DB_UNDEFINED)
	{
		...
		if($con === null)
			$con = Propel::getConnection(EmailIngestionProfilePeer::DATABASE_NAME, Propel::CONNECTION_READ);
	...
	{
		$criteria_filter = EmailIngestionProfilePeer::getCriteriaFilter();
	...
	{
		EmailIngestionProfilePeer::getCriteriaFilter()->applyFilter($criteria);
	}
	...
	public static function doCountStmt(Criteria $criteria, PropelPDO $con = null)
	{
		...
		$con = EmailIngestionProfilePeer::alternativeCon ( $con );
	 ...
	 *
	 * @param      EmailIngestionProfile $value A EmailIngestionProfile object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(EmailIngestionProfile $obj, $key = null)
	{
	 ...
	 *
	 * @param      mixed $value A EmailIngestionProfile object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof EmailIngestionProfile) {
				$key = (string) $value->getId();
			} elseif (is_scalar($value)) {
				// assume we've been passed a primary key
				$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or EmailIngestionProfile object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     EmailIngestionProfile Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to email_ingestion_profile
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = EmailIngestionProfilePeer::getOMClass(false);
		// populate the object(s)
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key = EmailIngestionProfilePeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj = EmailIngestionProfilePeer::getInstanceFromPool($key))) {
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseEmailIngestionProfilePeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseEmailIngestionProfilePeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new EmailIngestionProfileTableMap());
	  }
	}
	...
	{
		return $withPrefix ? EmailIngestionProfilePeer::CLASS_DEFAULT : EmailIngestionProfilePeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a EmailIngestionProfile or Criteria object.
	 *
	 * @param      mixed $values Criteria or EmailIngestionProfile object containing data that is used to create the INSERT statement.
	...
	{
		if ($con === null) {
			$con = Propel::getConnection(EmailIngestionProfilePeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
		}

		if ($values instanceof Criteria) {
			$criteria = clone $values; // rename for clarity
		} else {
			$criteria = $values->buildCriteria(); // build Criteria from EmailIngestionProfile object
		}

		if ($criteria->containsKey(EmailIngestionProfilePeer::ID) && $criteria->keyContainsValue(EmailIngestionProfilePeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.EmailIngestionProfilePeer::ID.')');
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a EmailIngestionProfile or Criteria object.
	 *
	 * @param      mixed $values Criteria or EmailIngestionProfile object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		} else { // $values is EmailIngestionProfile object
	...
	/**
	 * Method to DELETE all rows from the email_ingestion_profile table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			EmailIngestionProfilePeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Method perform a DELETE on the database, given a EmailIngestionProfile or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or EmailIngestionProfile object or primary key or array of primary keys
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
		...
		} elseif ($values instanceof EmailIngestionProfile) { // it's a model object
			// invalidate the cache for this single object
			EmailIngestionProfilePeer::removeInstanceFromPool($values);
			...
			foreach ((array) $values as $singleval) {
				EmailIngestionProfilePeer::removeInstanceFromPool($singleval);
			}
		}
	...
	/**
	 * Validates all modified columns of given EmailIngestionProfile object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      EmailIngestionProfile $obj The object to validate.
	...
	public static function doValidate(EmailIngestionProfile $obj, $cols = null)
	{
		...
		return BasePeer::doValidate(EmailIngestionProfilePeer::DATABASE_NAME, EmailIngestionProfilePeer::TABLE_NAME, $columns);
	}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = EmailIngestionProfilePeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
...
} // BaseEmailIngestionProfilePeer

// This is the static code needed to register the TableMap for this table with the main Propel class.
//
BaseEmailIngestionProfilePeer::buildTableMap();
