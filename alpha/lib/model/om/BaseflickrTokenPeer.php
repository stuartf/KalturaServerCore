...
/**
 * Base static class for performing query and update operations on the 'flickr_token' table.
 *
 * 
 *
 * @package Core
...
abstract class BaseflickrTokenPeer {
	...
	const OM_CLASS = 'flickrToken';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'Core.flickrToken';

	/** the related TableMap class for this table */
	const TM_CLASS = 'flickrTokenTableMap';
	...
	/** the column name for the NSID field */
	...
	/**
	 * An identiy map to hold any loaded instances of flickrToken objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array flickrToken[]
	 */
	 ...
	 * @param      string $column The column name for current table. (i.e. flickrTokenPeer::COLUMN_NAME).
	 * @return     string
	 */
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$criteria->setPrimaryTableName(flickrTokenPeer::TABLE_NAME);
	...
	public static function updateInstancePool(&$queryResult)
	{
		...
		{
			$objFromPool = flickrTokenPeer::getInstanceFromPool($curObject->getPrimaryKey());
			if ($objFromPool === null)
			{
				flickrTokenPeer::addInstanceToPool($curObject);
			}
			else
			{
	...
	public static function addInstancesToPool($queryResult)
	{
		...
		{
			flickrTokenPeer::addInstanceToPool($curResult);
		}
	}
	...
	public static function alternativeCon($con, $queryDB = kQueryCache::QUERY_DB_UNDEFINED)
	{
		...
		if($con === null)
			$con = Propel::getConnection(flickrTokenPeer::DATABASE_NAME, Propel::CONNECTION_READ);
	...
	{
		$criteria_filter = flickrTokenPeer::getCriteriaFilter();
	...
	public static function doCountStmt(Criteria $criteria, PropelPDO $con = null)
	{
		...
		$con = flickrTokenPeer::alternativeCon ( $con );
	 ...
	 *
	 * @param      flickrToken $value A flickrToken object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(flickrToken $obj, $key = null)
	{
	 ...
	 *
	 * @param      mixed $value A flickrToken object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof flickrToken) {
				...
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or flickrToken object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     flickrToken Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to flickr_token
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = flickrTokenPeer::getOMClass(false);
		// populate the object(s)
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key = flickrTokenPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj = flickrTokenPeer::getInstanceFromPool($key))) {
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseflickrTokenPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseflickrTokenPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new flickrTokenTableMap());
	  }
	}
	...
	{
		return $withPrefix ? flickrTokenPeer::CLASS_DEFAULT : flickrTokenPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a flickrToken or Criteria object.
	 *
	 * @param      mixed $values Criteria or flickrToken object containing data that is used to create the INSERT statement.
	...
	{
		if ($con === null) {
			$con = Propel::getConnection(flickrTokenPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
		}

		if ($values instanceof Criteria) {
			$criteria = clone $values; // rename for clarity
		} else {
			$criteria = $values->buildCriteria(); // build Criteria from flickrToken object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a flickrToken or Criteria object.
	 *
	 * @param      mixed $values Criteria or flickrToken object containing data that is used to create the UPDATE statement.
	...
	/**
	 * Method to DELETE all rows from the flickr_token table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			flickrTokenPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Method perform a DELETE on the database, given a flickrToken or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or flickrToken object or primary key or array of primary keys
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof flickrToken) { // it's a model object
			// invalidate the cache for this single object
			flickrTokenPeer::removeInstanceFromPool($values);
	...
	/**
	 * Validates all modified columns of given flickrToken object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      flickrToken $obj The object to validate.
	...
	public static function doValidate(flickrToken $obj, $cols = null)
	{
		...
		return BasePeer::doValidate(flickrTokenPeer::DATABASE_NAME, flickrTokenPeer::TABLE_NAME, $columns);
	}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = flickrTokenPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
...
//
BaseflickrTokenPeer::buildTableMap();
