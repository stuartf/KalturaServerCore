...
abstract class BaseWidgetLogPeer {
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$con = WidgetLogPeer::alternativeCon ($con, $queryDB);
	...
	public static function updateInstancePool(&$queryResult)
	{
		...
		{
			$objFromPool = WidgetLogPeer::getInstanceFromPool($curObject->getPrimaryKey());
			if ($objFromPool === null)
			{
				WidgetLogPeer::addInstanceToPool($curObject);
			}
			else
			{
	...
	public static function addInstancesToPool($queryResult)
	{
		...
		{
			WidgetLogPeer::addInstanceToPool($curResult);
		}
	}
	...
	{		
		$criteria = WidgetLogPeer::prepareCriteriaForSelect($criteria);
		...
		if ($cachedResult !== null)
		{
			WidgetLogPeer::filterSelectResults($cachedResult);
		...
		WidgetLogPeer::filterSelectResults($queryResult);
