...
/**
 * Base class that represents a row from the 'user_login_data' table.
 *
 * 
 *
 * @package Core
 * @subpackage model.om
 */
abstract class BaseUserLoginData extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the login_email field.
	 * @var        string
	 */
	...
	/**
	 * Get the [login_email] column value.
	 * 
	 * @return     string
	 */
	...
	{
		if(!isset($this->oldColumnsValues[UserLoginDataPeer::ID]))
			$this->oldColumnsValues[UserLoginDataPeer::ID] = $this->id;
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = UserLoginDataPeer::ID;
		}
	...
	/**
	 * Set the value of [login_email] column.
	 * 
	...
	{
		if(!isset($this->oldColumnsValues[UserLoginDataPeer::LOGIN_EMAIL]))
			$this->oldColumnsValues[UserLoginDataPeer::LOGIN_EMAIL] = $this->login_email;

		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->login_email !== $v) {
			$this->login_email = $v;
			$this->modifiedColumns[] = UserLoginDataPeer::LOGIN_EMAIL;
		}
	...
	{
		if(!isset($this->oldColumnsValues[UserLoginDataPeer::FIRST_NAME]))
			$this->oldColumnsValues[UserLoginDataPeer::FIRST_NAME] = $this->first_name;
		...
		if ($this->first_name !== $v) {
			$this->first_name = $v;
			$this->modifiedColumns[] = UserLoginDataPeer::FIRST_NAME;
		}
	...
	{
		if(!isset($this->oldColumnsValues[UserLoginDataPeer::LAST_NAME]))
			$this->oldColumnsValues[UserLoginDataPeer::LAST_NAME] = $this->last_name;
		...
		if ($this->last_name !== $v) {
			$this->last_name = $v;
			$this->modifiedColumns[] = UserLoginDataPeer::LAST_NAME;
		}
	...
	{
		if(!isset($this->oldColumnsValues[UserLoginDataPeer::SHA1_PASSWORD]))
			$this->oldColumnsValues[UserLoginDataPeer::SHA1_PASSWORD] = $this->sha1_password;
		...
		if ($this->sha1_password !== $v) {
			...
			$this->modifiedColumns[] = UserLoginDataPeer::SHA1_PASSWORD;
		}
	...
	{
		if(!isset($this->oldColumnsValues[UserLoginDataPeer::SALT]))
			$this->oldColumnsValues[UserLoginDataPeer::SALT] = $this->salt;
		...
		if ($this->salt !== $v) {
			$this->salt = $v;
			$this->modifiedColumns[] = UserLoginDataPeer::SALT;
		}
	...
	{
		if(!isset($this->oldColumnsValues[UserLoginDataPeer::LOGIN_BLOCKED_UNTIL]))
			$this->oldColumnsValues[UserLoginDataPeer::LOGIN_BLOCKED_UNTIL] = $this->login_blocked_until;
		...
		if ( $this->login_blocked_until !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = UserLoginDataPeer::LOGIN_BLOCKED_UNTIL;
			}
	...
	public function setCustomData($v)
	{
		...
		if ($this->custom_data !== $v) {
			$this->custom_data = $v;
			$this->modifiedColumns[] = UserLoginDataPeer::CUSTOM_DATA;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->login_email = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = UserLoginDataPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
		UserLoginDataPeer::setUseCriteriaFilter(true);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				UserLoginDataPeer::doDelete($this, $con);
				$this->postDelete($con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				UserLoginDataPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = UserLoginDataPeer::doInsert($this, $con);
					...
					$affectedRows += UserLoginDataPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = UserLoginDataPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = UserLoginDataPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setLoginEmail($arr[$keys[1]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(UserLoginDataPeer::ID)) $criteria->add(UserLoginDataPeer::ID, $this->id);
		if ($this->isColumnModified(UserLoginDataPeer::LOGIN_EMAIL)) $criteria->add(UserLoginDataPeer::LOGIN_EMAIL, $this->login_email);
		if ($this->isColumnModified(UserLoginDataPeer::FIRST_NAME)) $criteria->add(UserLoginDataPeer::FIRST_NAME, $this->first_name);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(UserLoginDataPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of UserLoginData (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setLoginEmail($this->login_email);
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     UserLoginData Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @var     UserLoginData Clone of current object.
	 */
	 ...
	 * Stores the source object that this object copied from 
	 *
	 * @param      UserLoginData $copiedFrom Clone of current object.
	 */
	public function setCopiedFrom(UserLoginData $copiedFrom)
	{
	 ...
	 *
	 * @return     UserLoginDataPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new UserLoginDataPeer();
		}
		return self::$peer;
	}
