...
/**
 * Base static class for performing query and update operations on the 'user_login_data' table.
 *
 * 
 *
 * @package Core
 * @subpackage model.om
 */
abstract class BaseUserLoginDataPeer {

	/** the default database name for this class */
	const DATABASE_NAME = 'propel';

	/** the table name for this class */
	const TABLE_NAME = 'user_login_data';

	/** the related Propel class for this table */
	const OM_CLASS = 'UserLoginData';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'Core.UserLoginData';
	...
	const ID = 'user_login_data.ID';

	/** the column name for the LOGIN_EMAIL field */
	const LOGIN_EMAIL = 'user_login_data.LOGIN_EMAIL';

	/** the column name for the FIRST_NAME field */
	const FIRST_NAME = 'user_login_data.FIRST_NAME';

	/** the column name for the LAST_NAME field */
	const LAST_NAME = 'user_login_data.LAST_NAME';

	/** the column name for the SHA1_PASSWORD field */
	const SHA1_PASSWORD = 'user_login_data.SHA1_PASSWORD';
	...
	const CREATED_AT = 'user_login_data.CREATED_AT';

	/** the column name for the UPDATED_AT field */
	const UPDATED_AT = 'user_login_data.UPDATED_AT';

	/** the column name for the CUSTOM_DATA field */
	const CUSTOM_DATA = 'user_login_data.CUSTOM_DATA';

	/**
	 * An identiy map to hold any loaded instances of UserLoginData objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array UserLoginData[]
	 */
	 ...
	 * @param      string $column The column name for current table. (i.e. UserLoginDataPeer::COLUMN_NAME).
	 * @return     string
	 */
	public static function alias($alias, $column)
	{
		return str_replace(UserLoginDataPeer::TABLE_NAME.'.', $alias.'.', $column);
	}
	...
	{
		$criteria->addSelectColumn(UserLoginDataPeer::ID);
		$criteria->addSelectColumn(UserLoginDataPeer::LOGIN_EMAIL);
		$criteria->addSelectColumn(UserLoginDataPeer::FIRST_NAME);
		...
		$criteria->addSelectColumn(UserLoginDataPeer::CUSTOM_DATA);
	}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$criteria->setPrimaryTableName(UserLoginDataPeer::TABLE_NAME);
		...
		if (!$criteria->hasSelectClause()) {
			UserLoginDataPeer::addSelectColumns($criteria);
		}
	...
	public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
	{
		...
		$critcopy->setLimit(1);
		$objects = UserLoginDataPeer::doSelect($critcopy, $con);
		if ($objects) {
			return $objects[0];
		}
		return null;
	...
	public static function alternativeCon($con, $queryDB = kQueryCache::QUERY_DB_UNDEFINED)
	{
		...
		if($con === null)
			$con = Propel::getConnection(UserLoginDataPeer::DATABASE_NAME, Propel::CONNECTION_READ);
	...
	{
		$criteria_filter = UserLoginDataPeer::getCriteriaFilter();
	...
	{
		UserLoginDataPeer::getCriteriaFilter()->applyFilter($criteria);
	}
	 ...
	 *
	 * @param      mixed $value A UserLoginData object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof UserLoginData) {
				$key = (string) $value->getId();
			} elseif (is_scalar($value)) {
				// assume we've been passed a primary key
				$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or UserLoginData object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     UserLoginData Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to user_login_data
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = UserLoginDataPeer::getOMClass(false);
		// populate the object(s)
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key = UserLoginDataPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj = UserLoginDataPeer::getInstanceFromPool($key))) {
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseUserLoginDataPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseUserLoginDataPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new UserLoginDataTableMap());
	  }
	}
	...
	{
		return $withPrefix ? UserLoginDataPeer::CLASS_DEFAULT : UserLoginDataPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a UserLoginData or Criteria object.
	 *
	 * @param      mixed $values Criteria or UserLoginData object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from UserLoginData object
		}

		if ($criteria->containsKey(UserLoginDataPeer::ID) && $criteria->keyContainsValue(UserLoginDataPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.UserLoginDataPeer::ID.')');
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a UserLoginData or Criteria object.
	 *
	 * @param      mixed $values Criteria or UserLoginData object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(UserLoginDataPeer::ID);
			$selectCriteria->add(UserLoginDataPeer::ID, $criteria->remove(UserLoginDataPeer::ID), $comparison);

		} else { // $values is UserLoginData object
	...
	/**
	 * Method to DELETE all rows from the user_login_data table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(UserLoginDataPeer::TABLE_NAME, $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof UserLoginData) { // it's a model object
	...
	/**
	 * Validates all modified columns of given UserLoginData object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      UserLoginData $obj The object to validate.
	 * @param      mixed $cols Column name or array of column names.
	 *
	 * @return     mixed TRUE if all columns are valid or the error message of the first invalid column.
	 */
	public static function doValidate(UserLoginData $obj, $cols = null)
	{
		$columns = array();

		if ($cols) {
			$dbMap = Propel::getDatabaseMap(UserLoginDataPeer::DATABASE_NAME);
			$tableMap = $dbMap->getTable(UserLoginDataPeer::TABLE_NAME);
		...
		return BasePeer::doValidate(UserLoginDataPeer::DATABASE_NAME, UserLoginDataPeer::TABLE_NAME, $columns);
	}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = UserLoginDataPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}

		$criteria = new Criteria(UserLoginDataPeer::DATABASE_NAME);
		$criteria->add(UserLoginDataPeer::ID, $pk);

		$v = UserLoginDataPeer::doSelect($criteria, $con);
...
} // BaseUserLoginDataPeer

// This is the static code needed to register the TableMap for this table with the main Propel class.
//
BaseUserLoginDataPeer::buildTableMap();
