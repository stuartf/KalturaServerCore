...
abstract class BasePriorityGroupPeer {
	...
	public static function updateInstancePool(&$queryResult)
	{
		...
		{
			$objFromPool = PriorityGroupPeer::getInstanceFromPool($curObject->getPrimaryKey());
			if ($objFromPool === null)
			{
				PriorityGroupPeer::addInstanceToPool($curObject);
			}
			else
			{
	...
	public static function addInstancesToPool($queryResult)
	{
		...
		{
			PriorityGroupPeer::addInstanceToPool($curResult);
		}
	}
