...
abstract class BaseSchedulerPeer {
	...
	const OM_CLASS = 'Scheduler';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'Core.Scheduler';

	/** the related TableMap class for this table */
	const TM_CLASS = 'SchedulerTableMap';
	...
	/**
	 * An identiy map to hold any loaded instances of Scheduler objects.
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'createdAt', 'createdBy', 'updatedAt', 'updatedBy', 'configuredId', 'name', 'description', 'statuses', 'lastStatus', 'host', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::CREATED_AT, self::CREATED_BY, self::UPDATED_AT, self::UPDATED_BY, self::CONFIGURED_ID, self::NAME, self::DESCRIPTION, self::STATUSES, self::LAST_STATUS, self::HOST, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'createdAt' => 1, 'createdBy' => 2, 'updatedAt' => 3, 'updatedBy' => 4, 'configuredId' => 5, 'name' => 6, 'description' => 7, 'statuses' => 8, 'lastStatus' => 9, 'host' => 10, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::CREATED_AT => 1, self::CREATED_BY => 2, self::UPDATED_AT => 3, self::UPDATED_BY => 4, self::CONFIGURED_ID => 5, self::NAME => 6, self::DESCRIPTION => 7, self::STATUSES => 8, self::LAST_STATUS => 9, self::HOST => 10, ),
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$criteria->setPrimaryTableName(SchedulerPeer::TABLE_NAME);
		...
		SchedulerPeer::attachCriteriaFilter($criteria);
		...
		$con = SchedulerPeer::alternativeCon ($con, $queryDB);
	...
	public static function updateInstancePool(&$queryResult)
	{
		...
		{
			$objFromPool = SchedulerPeer::getInstanceFromPool($curObject->getPrimaryKey());
			if ($objFromPool === null)
			{
				SchedulerPeer::addInstanceToPool($curObject);
			}
			else
			{
	...
	{		
		$criteria = SchedulerPeer::prepareCriteriaForSelect($criteria);
		...
		if ($cachedResult !== null)
		{
			SchedulerPeer::filterSelectResults($cachedResult);
			SchedulerPeer::updateInstancePool($cachedResult);
			return $cachedResult;
		}
		
		$con = SchedulerPeer::alternativeCon($con, $queryDB);
		
		$queryResult = SchedulerPeer::populateObjects(BasePeer::doSelect($criteria, $con));
		...
		SchedulerPeer::filterSelectResults($queryResult);
	...
	public static function alternativeCon($con, $queryDB = kQueryCache::QUERY_DB_UNDEFINED)
	{
		...
		if($con === null)
			$con = Propel::getConnection(SchedulerPeer::DATABASE_NAME, Propel::CONNECTION_READ);
	...
	{
		$criteria_filter = SchedulerPeer::getCriteriaFilter();
	...
	public static function &getCriteriaFilter()
	{
		if(self::$s_criteria_filter == null)
			SchedulerPeer::setDefaultCriteriaFilter();
	...
	{
		SchedulerPeer::getCriteriaFilter()->applyFilter($criteria);
	}
	...
	public static function doCountStmt(Criteria $criteria, PropelPDO $con = null)
	{
		...
		$con = SchedulerPeer::alternativeCon ( $con );
	 ...
	 *
	 * @param      mixed $value A Scheduler object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Scheduler) {
				$key = (string) $value->getId();
			} elseif (is_scalar($value)) {
				// assume we've been passed a primary key
				$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or Scheduler object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     Scheduler Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to scheduler
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = SchedulerPeer::getOMClass(false);
		// populate the object(s)
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key = SchedulerPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj = SchedulerPeer::getInstanceFromPool($key))) {
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseSchedulerPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseSchedulerPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new SchedulerTableMap());
	  }
	}
	...
	{
		return $withPrefix ? SchedulerPeer::CLASS_DEFAULT : SchedulerPeer::OM_CLASS;
	}
	...
	{
		if ($con === null) {
			$con = Propel::getConnection(SchedulerPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
		}
		...
		if ($criteria->containsKey(SchedulerPeer::ID) && $criteria->keyContainsValue(SchedulerPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.SchedulerPeer::ID.')');
		}
	 ...
	 *
	 * @param      mixed $values Criteria or Scheduler object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		} else { // $values is Scheduler object
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			SchedulerPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
		...
		} elseif ($values instanceof Scheduler) { // it's a model object
			// invalidate the cache for this single object
			SchedulerPeer::removeInstanceFromPool($values);
			...
			foreach ((array) $values as $singleval) {
				SchedulerPeer::removeInstanceFromPool($singleval);
			}
		}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = SchedulerPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
...
//
BaseSchedulerPeer::buildTableMap();
