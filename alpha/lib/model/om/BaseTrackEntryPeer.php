...
abstract class BaseTrackEntryPeer {
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$con = TrackEntryPeer::alternativeCon ($con, $queryDB);
	...
	public static function updateInstancePool(&$queryResult)
	{
		...
		{
			$objFromPool = TrackEntryPeer::getInstanceFromPool($curObject->getPrimaryKey());
			if ($objFromPool === null)
			{
				TrackEntryPeer::addInstanceToPool($curObject);
			}
			else
			{
	...
	public static function addInstancesToPool($queryResult)
	{
		...
		{
			TrackEntryPeer::addInstanceToPool($curResult);
		}
	}
	...
	{		
		$criteria = TrackEntryPeer::prepareCriteriaForSelect($criteria);
		...
		if ($cachedResult !== null)
		{
			TrackEntryPeer::filterSelectResults($cachedResult);
		...
		$queryResult = TrackEntryPeer::populateObjects(BasePeer::doSelect($criteria, $con));
		...
		TrackEntryPeer::filterSelectResults($queryResult);
