...
/**
 * Base static class for performing query and update operations on the 'conversion_params' table.
 *
 * 
 *
 * @package Core
...
abstract class BaseConversionParamsPeer {
	...
	/** the column name for the PROFILE_TYPE_INDEX field */
	...
	/** the column name for the QSCALE field */
	const QSCALE = 'conversion_params.QSCALE';

	/** the column name for the FILE_SUFFIX field */
	...
	/**
	 * An identiy map to hold any loaded instances of ConversionParams objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array ConversionParams[]
	 */
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'partnerId', 'enabled', 'name', 'profileType', 'profileTypeIndex', 'width', 'height', 'aspectRatio', 'gopSize', 'bitrate', 'qscale', 'fileSuffix', 'customData', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::PARTNER_ID, self::ENABLED, self::NAME, self::PROFILE_TYPE, self::PROFILE_TYPE_INDEX, self::WIDTH, self::HEIGHT, self::ASPECT_RATIO, self::GOP_SIZE, self::BITRATE, self::QSCALE, self::FILE_SUFFIX, self::CUSTOM_DATA, self::CREATED_AT, self::UPDATED_AT, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'partnerId' => 1, 'enabled' => 2, 'name' => 3, 'profileType' => 4, 'profileTypeIndex' => 5, 'width' => 6, 'height' => 7, 'aspectRatio' => 8, 'gopSize' => 9, 'bitrate' => 10, 'qscale' => 11, 'fileSuffix' => 12, 'customData' => 13, 'createdAt' => 14, 'updatedAt' => 15, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::PARTNER_ID => 1, self::ENABLED => 2, self::NAME => 3, self::PROFILE_TYPE => 4, self::PROFILE_TYPE_INDEX => 5, self::WIDTH => 6, self::HEIGHT => 7, self::ASPECT_RATIO => 8, self::GOP_SIZE => 9, self::BITRATE => 10, self::QSCALE => 11, self::FILE_SUFFIX => 12, self::CUSTOM_DATA => 13, self::CREATED_AT => 14, self::UPDATED_AT => 15, ),
	 ...
	 * @param      string $column The column name for current table. (i.e. ConversionParamsPeer::COLUMN_NAME).
	 * @return     string
	 */
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$criteria->setPrimaryTableName(ConversionParamsPeer::TABLE_NAME);
		...
		ConversionParamsPeer::attachCriteriaFilter($criteria);
	...
	public static function updateInstancePool(&$queryResult)
	{
		...
		{
			$objFromPool = ConversionParamsPeer::getInstanceFromPool($curObject->getPrimaryKey());
			if ($objFromPool === null)
			{
				ConversionParamsPeer::addInstanceToPool($curObject);
			}
			else
			{
	...
	public static function addInstancesToPool($queryResult)
	{
		...
		{
			ConversionParamsPeer::addInstanceToPool($curResult);
		}
	}
	...
	{
		$criteria_filter = ConversionParamsPeer::getCriteriaFilter();
	...
	public static function &getCriteriaFilter()
	{
		if(self::$s_criteria_filter == null)
			ConversionParamsPeer::setDefaultCriteriaFilter();
	...
	{
		ConversionParamsPeer::getCriteriaFilter()->applyFilter($criteria);
	}
	...
	public static function doCountStmt(Criteria $criteria, PropelPDO $con = null)
	{
		...
		$con = ConversionParamsPeer::alternativeCon ( $con );
	 ...
	 *
	 * @param      ConversionParams $value A ConversionParams object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(ConversionParams $obj, $key = null)
	{
	 ...
	 *
	 * @param      mixed $value A ConversionParams object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof ConversionParams) {
				$key = (string) $value->getId();
			} elseif (is_scalar($value)) {
				// assume we've been passed a primary key
				$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or ConversionParams object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     ConversionParams Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to conversion_params
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = ConversionParamsPeer::getOMClass(false);
		// populate the object(s)
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key = ConversionParamsPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj = ConversionParamsPeer::getInstanceFromPool($key))) {
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseConversionParamsPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseConversionParamsPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new ConversionParamsTableMap());
	  }
	}
	...
	{
		return $withPrefix ? ConversionParamsPeer::CLASS_DEFAULT : ConversionParamsPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a ConversionParams or Criteria object.
	 *
	 * @param      mixed $values Criteria or ConversionParams object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from ConversionParams object
		}

		if ($criteria->containsKey(ConversionParamsPeer::ID) && $criteria->keyContainsValue(ConversionParamsPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.ConversionParamsPeer::ID.')');
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a ConversionParams or Criteria object.
	 *
	 * @param      mixed $values Criteria or ConversionParams object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		} else { // $values is ConversionParams object
	...
	/**
	 * Method to DELETE all rows from the conversion_params table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			ConversionParamsPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Method perform a DELETE on the database, given a ConversionParams or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or ConversionParams object or primary key or array of primary keys
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
		...
		} elseif ($values instanceof ConversionParams) { // it's a model object
			// invalidate the cache for this single object
			ConversionParamsPeer::removeInstanceFromPool($values);
			...
			foreach ((array) $values as $singleval) {
				ConversionParamsPeer::removeInstanceFromPool($singleval);
			}
		}
	...
	/**
	 * Validates all modified columns of given ConversionParams object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      ConversionParams $obj The object to validate.
	...
	public static function doValidate(ConversionParams $obj, $cols = null)
	{
		...
		return BasePeer::doValidate(ConversionParamsPeer::DATABASE_NAME, ConversionParamsPeer::TABLE_NAME, $columns);
	}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = ConversionParamsPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
...
} // BaseConversionParamsPeer

// This is the static code needed to register the TableMap for this table with the main Propel class.
//
BaseConversionParamsPeer::buildTableMap();
