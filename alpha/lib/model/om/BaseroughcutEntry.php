...
/**
 * Base class that represents a row from the 'roughcut_entry' table.
 *
 * 
 *
 * @package Core
...
abstract class BaseroughcutEntry extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the roughcut_id field.
	 * @var        string
	 */
	protected $roughcut_id;

	/**
	 * The value for the roughcut_version field.
	 * @var        int
	 */
	...
	/**
	 * The value for the op_type field.
	 * @var        int
	 */
	protected $op_type;
	...
	/**
	 * Get the [roughcut_id] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Get the [roughcut_version] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Set the value of [roughcut_id] column.
	 * 
	...
	/**
	 * Set the value of [roughcut_version] column.
	 * 
	 * @param      int $v new value
	 * @return     roughcutEntry The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [op_type] column.
	 * 
	 * @param      int $v new value
	 * @return     roughcutEntry The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 9; // 9 = roughcutEntryPeer::NUM_COLUMNS - roughcutEntryPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		roughcutEntryPeer::setUseCriteriaFilter(false);
		$stmt = roughcutEntryPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
		roughcutEntryPeer::setUseCriteriaFilter(true);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				roughcutEntryPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->aentryRelatedByRoughcutId !== null) {
				if ($this->aentryRelatedByRoughcutId->isModified() || $this->aentryRelatedByRoughcutId->isNew()) {
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of roughcutEntry (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     roughcutEntry Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @var     roughcutEntry Clone of current object.
	 */
	 ...
	 * Stores the source object that this object copied from 
	 *
	 * @param      roughcutEntry $copiedFrom Clone of current object.
	 */
	public function setCopiedFrom(roughcutEntry $copiedFrom)
	{
	 ...
	 * @throws     PropelException
	 */
	public function setentryRelatedByRoughcutId(entry $v = null)
	{
		if ($v === null) {
		...
		if ($v !== null) {
			$v->addroughcutEntryRelatedByRoughcutId($this);
		}
	 ...
	 * @throws     PropelException
	 */
	public function getentryRelatedByRoughcutId(PropelPDO $con = null)
	{
		if ($this->aentryRelatedByRoughcutId === null && (($this->roughcut_id !== "" && $this->roughcut_id !== null))) {
			$this->aentryRelatedByRoughcutId = entryPeer::retrieveByPk($this->roughcut_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aentryRelatedByRoughcutId->addroughcutEntrysRelatedByRoughcutId($this);
			 */
		}
	 ...
	 * @throws     PropelException
	 */
	public function setentryRelatedByEntryId(entry $v = null)
	{
		if ($v === null) {
		...
		// If this object has already been added to the entry object, it will not be re-added.
		if ($v !== null) {
			$v->addroughcutEntryRelatedByEntryId($this);
		}
	 ...
	 * @throws     PropelException
	 */
	public function getentryRelatedByEntryId(PropelPDO $con = null)
	{
		if ($this->aentryRelatedByEntryId === null && (($this->entry_id !== "" && $this->entry_id !== null))) {
			$this->aentryRelatedByEntryId = entryPeer::retrieveByPk($this->entry_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aentryRelatedByEntryId->addroughcutEntrysRelatedByEntryId($this);
			 */
		}
