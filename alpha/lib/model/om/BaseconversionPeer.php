...
abstract class BaseconversionPeer {
	...
	const CLASS_DEFAULT = 'Core.conversion';
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		conversionPeer::attachCriteriaFilter($criteria);
		...
		$con = conversionPeer::alternativeCon ($con, $queryDB);
	...
	public static function updateInstancePool(&$queryResult)
	{
		...
		{
			$objFromPool = conversionPeer::getInstanceFromPool($curObject->getPrimaryKey());
			if ($objFromPool === null)
			{
				conversionPeer::addInstanceToPool($curObject);
			}
			else
			{
	...
	public static function addInstancesToPool($queryResult)
	{
		...
		{
			conversionPeer::addInstanceToPool($curResult);
		}
	}
	...
	{		
		$criteria = conversionPeer::prepareCriteriaForSelect($criteria);
		...
		if ($cachedResult !== null)
		{
			conversionPeer::filterSelectResults($cachedResult);
		...
		$queryResult = conversionPeer::populateObjects(BasePeer::doSelect($criteria, $con));
		...
		conversionPeer::filterSelectResults($queryResult);
		conversionPeer::addInstancesToPool($queryResult);
		return $queryResult;
	}
	...
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof conversion) {
				...
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or conversion object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key = conversionPeer::getPrimaryKeyHashFromRow($row, 0);
	...
	public static function doSelectJoinentry(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		conversionPeer::addSelectColumns($criteria);
		$startcol = (conversionPeer::NUM_COLUMNS - conversionPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key1 = conversionPeer::getPrimaryKeyHashFromRow($row, 0);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		conversionPeer::addSelectColumns($criteria);
		$startcol2 = (conversionPeer::NUM_COLUMNS - conversionPeer::NUM_LAZY_LOAD_COLUMNS);
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			conversionPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			conversionPeer::removeInstanceFromPool($values);
			...
			foreach ((array) $values as $singleval) {
				conversionPeer::removeInstanceFromPool($singleval);
			}
		}
