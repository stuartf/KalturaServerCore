...
abstract class BasealertPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'kuserId', 'alertType', 'subjectId', 'ruleType', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::KUSER_ID, self::ALERT_TYPE, self::SUBJECT_ID, self::RULE_TYPE, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'kuserId' => 1, 'alertType' => 2, 'subjectId' => 3, 'ruleType' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::KUSER_ID => 1, self::ALERT_TYPE => 2, self::SUBJECT_ID => 3, self::RULE_TYPE => 4, ),
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$stmt = alertPeer::doCountStmt($criteria, $con);
	...
	{
		$criteria_filter = alertPeer::getCriteriaFilter();
	...
	public static function &getCriteriaFilter()
	{
		if(self::$s_criteria_filter == null)
			alertPeer::setDefaultCriteriaFilter();
	...
	{
		alertPeer::getCriteriaFilter()->applyFilter($criteria);
	}
	...
	public static function doCountStmt(Criteria $criteria, PropelPDO $con = null)
	{
		...
		alertPeer::attachCriteriaFilter($criteria);
		
		// set the connection to slave server
		$con = alertPeer::alternativeCon ( $con );
	...
	public static function doCountJoinkuser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(alertPeer::KUSER_ID, kuserPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of alert objects pre-filled with their kuser objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinkuser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (alert) to $obj2 (kuser)
				$obj2->addalert($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (alert) to the collection in $obj2 (kuser)
				$obj2->addalert($obj1);
