 ...
 * @subpackage Client
 */
class Kaltura_Client_MultiCenters_FilesyncImportBatchService extends Kaltura_Client_ServiceBase
{
	...
	function getExclusiveFileSyncImportJobs(Kaltura_Client_Type_ExclusiveLockKey $lockKey, $maxExecutionTime, $numberOfJobs, Kaltura_Client_Type_BatchJobFilter $filter = null)
	{
		$kparams = array();
	...
	function updateExclusiveFileSyncImportJob($id, Kaltura_Client_Type_ExclusiveLockKey $lockKey, Kaltura_Client_Type_BatchJob $job)
	{
		$kparams = array();
	...
	function freeExclusiveFileSyncImportJob($id, Kaltura_Client_Type_ExclusiveLockKey $lockKey, $resetExecutionAttempts = false)
	{
		$kparams = array();
		$this->client->addParam($kparams, "id", $id);
		$this->client->addParam($kparams, "lockKey", $lockKey->toParams());
	...
	function getExclusiveAlmostDoneFileSyncImportJobs(Kaltura_Client_Type_ExclusiveLockKey $lockKey, $maxExecutionTime, $numberOfJobs, Kaltura_Client_Type_BatchJobFilter $filter = null)
	{
		$kparams = array();
		$this->client->addParam($kparams, "lockKey", $lockKey->toParams());
		$this->client->addParam($kparams, "maxExecutionTime", $maxExecutionTime);
