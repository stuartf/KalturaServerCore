...
class Kaltura_Client_LiveStreamService extends Kaltura_Client_ServiceBase
{
	...
	function add(Kaltura_Client_Type_LiveStreamAdminEntry $liveStreamEntry, $sourceType = null)
	{
		$kparams = array();
		...
		$this->client->validateObjectType($resultObject, "Kaltura_Client_Type_LiveStreamAdminEntry");
		return $resultObject;
	}
	...
	function update($entryId, Kaltura_Client_Type_LiveStreamAdminEntry $liveStreamEntry)
	{
		$kparams = array();
		$this->client->addParam($kparams, "entryId", $entryId);
		$this->client->addParam($kparams, "liveStreamEntry", $liveStreamEntry->toParams());
