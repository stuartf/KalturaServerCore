...
class Kaltura_Client_KalturaInternalTools_Plugin extends Kaltura_Client_Plugin
{
	...
	/**
	 * @var Kaltura_Client_KalturaInternalTools_KalturaInternalToolsService
	 */
	...
	protected function __construct(Kaltura_Client_Client $client)
	{
		...
		$this->KalturaInternalTools = new Kaltura_Client_KalturaInternalTools_KalturaInternalToolsService($client);
