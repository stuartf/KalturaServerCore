...
//		$uniqid = uniqid("convert_{$job->entryId}_");
	...
	protected function getSupportedEnginesDescription()
	{
		...
		if  ( $this->taskConfig->params->useVlc ) $supported_engines_arr[] = "[" . KalturaConversionEngineType::VLC . "] vlc";
		if  ( $this->taskConfig->params->useMp4box ) $supported_engines_arr[] = "[" . KalturaConversionEngineType::MP4BOX . "] mp4box";
		if  ( $this->taskConfig->params->useInletArmada ) $supported_engines_arr[] = "[" . KalturaConversionEngineType::INLET_ARMADA . "] inlet_armada";
 ...
 */		 
		...
		if  ( $this->taskConfig->params->useVlc ) $supported_engines_arr[] = KalturaConversionEngineType::VLC;
		if  ( $this->taskConfig->params->useMp4box ) $supported_engines_arr[] = KalturaConversionEngineType::MP4BOX;
		if  ( $this->taskConfig->params->useInletArmada ) $supported_engines_arr[] = KalturaConversionEngineType::INLET_ARMADA;
