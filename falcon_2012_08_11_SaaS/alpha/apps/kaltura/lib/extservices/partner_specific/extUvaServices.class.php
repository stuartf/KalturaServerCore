...
class extUvaServices extends myBaseMediaSource implements IMediaSource
{
	...
	public function searchMedia( $media_type , $searchText, $page, $pageSize, $authData = null, $extraData= null )
	{
		...
		// this is an addition sent from the KCW
		$searchType = isset($_REQUEST["search_type"]) ? $_REQUEST["search_type"] : extUvaServices::SEARCH_TYPE_USER_CLIPS;
		...
		if ($shouldSearch) {
			...
			$numOfResults = $c->getRecordsCount();
