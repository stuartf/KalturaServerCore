        ...
        <tr>
            ...
            <td>
                <select name="monitorUsage" id="monitorUsage">
                    <option value="<?php echo PartnerFreeTrialType::NO_LIMIT; ?>" <?php echo (!$partner->getMonitorUsage())? 'selected="selected"': ''; ?>>Skip monitoring</option>
                    <option value="<?php echo PartnerFreeTrialType::LIMIT_BANDWIDTH; ?>" <?php echo ($partner->getMonitorUsage())? 'selected="selected"': ''; ?>>Limit bandwidth</option>
