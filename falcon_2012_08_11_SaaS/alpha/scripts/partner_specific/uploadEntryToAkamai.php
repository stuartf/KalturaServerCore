...
KAutoloader::setClassMapFilePath(kConf::get("cache_root_path") . '/partner/classMap.cache');
...
define('SCP_UPLOAD_PATH', 'bestbuy2.upload.akamai.com:/87182/');
...
function handleSingleEntry($entry_id, $force)
{
	...
	$akamai_user = 'sshacs';
	$akamai_rsa_key_path = '/opt/kaltura/data/bestbuy/id_rsa_bestbuy';
