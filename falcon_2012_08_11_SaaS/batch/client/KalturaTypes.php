 ...
 * @subpackage Client
 */
class KalturaFullStatusResponse extends KalturaObjectBase
{
	/**
 ...
 * @subpackage Client
 */
class KalturaSupportedSubTypes extends KalturaObjectBase
{
	/**
 ...
 * @subpackage Client
 */
class KalturaTypedArray extends KalturaObjectBase
{
	/**
	 * 
	 *
