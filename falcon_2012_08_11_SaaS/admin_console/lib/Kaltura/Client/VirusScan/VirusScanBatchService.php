 ...
 * @subpackage Client
 */
class Kaltura_Client_VirusScan_VirusScanBatchService extends Kaltura_Client_ServiceBase
{
	...
	function getExclusiveVirusScanJobs(Kaltura_Client_Type_ExclusiveLockKey $lockKey, $maxExecutionTime, $numberOfJobs, Kaltura_Client_Type_BatchJobFilter $filter = null)
	{
		$kparams = array();
	...
	function updateExclusiveVirusScanJob($id, Kaltura_Client_Type_ExclusiveLockKey $lockKey, Kaltura_Client_Type_BatchJob $job)
	{
		$kparams = array();
	...
	function freeExclusiveVirusScanJob($id, Kaltura_Client_Type_ExclusiveLockKey $lockKey, $resetExecutionAttempts = false)
	{
		$kparams = array();
		$this->client->addParam($kparams, "id", $id);
		$this->client->addParam($kparams, "lockKey", $lockKey->toParams());
