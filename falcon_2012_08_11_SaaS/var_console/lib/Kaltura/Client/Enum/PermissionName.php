 ...
 * @subpackage Client
 */
class Kaltura_Client_Enum_PermissionName
{
	...
	const SYSTEM_ADMIN_PUBLISHER_CONFIG_TECH_DATA = "systemPartner.SYSTEM_ADMIN_PUBLISHER_CONFIG_TECH_DATA";
	const SYSTEM_ADMIN_PUBLISHER_CONFIG_ACCOUNT_INFO = "systemPartner.SYSTEM_ADMIN_PUBLISHER_CONFIG_ACCOUNT_INFO";
	const SYSTEM_ADMIN_PUBLISHER_CONFIG_GROUP_OPTIONS = "systemPartner.SYSTEM_ADMIN_PUBLISHER_CONFIG_GROUP_OPTIONS";
	const SYSTEM_ADMIN_PUBLISHER_CONFIG_GENERAL_INFORMATION = "systemPartner.SYSTEM_ADMIN_PUBLISHER_CONFIG_GENERAL_INFORMATION";
	const SYSTEM_ADMIN_PUBLISHER_CONFIG_PACKAGES_SERVICE = "systemPartner.SYSTEM_ADMIN_PUBLISHER_CONFIG_PACKAGES_SERVICE";
	const SYSTEM_ADMIN_PUBLISHER_CONFIG_OPTIONS_MONITOR_USAGE = "systemPartner.SYSTEM_ADMIN_PUBLISHER_CONFIG_OPTIONS_MONITOR_USAGE";
	...
	const SYSTEM_ADMIN_EVENT_NOTIFICATION_BASE = "eventNotification.SYSTEM_ADMIN_EVENT_NOTIFICATION_BASE";
	const SYSTEM_ADMIN_EVENT_NOTIFICATION_MODIFY = "eventNotification.SYSTEM_ADMIN_EVENT_NOTIFICATION_MODIFY";
	const EVENT_NOTIFICATION_DISPATCH = "eventNotification.EVENT_NOTIFICATION_DISPATCH";
	const EVENT_NOTIFICATION_BASE = "eventNotification.EVENT_NOTIFICATION_BASE";
	const FEATURE_EVENT_NOTIFICATION = "eventNotification.FEATURE_EVENT_NOTIFICATION";
}
